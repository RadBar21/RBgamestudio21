...
export const TRANSLATIONS: Record<Language, any> = {
  cs: {
    ...
    contact: {
      ...
      placeholderEmail: 'jan@email.cz',
      placeholderMessage: 'Mám nápad na vylepšení...',
      btnSubmit: 'Odeslat zprávu',
      btnSubmitting: 'Odesílám...',
      successTitle: 'Odesláno!',
      successMessage: 'Děkuji za vaši zprávu. Odpovím vám co nejdříve na uvedený email.',
      btnSendNew: 'Poslat další zprávu',
  ...
  en: {
    ...
    contact: {
      ...
      placeholderMessage: 'I have an idea...',
      btnSubmit: 'Send Message',
      btnSubmitting: 'Sending...',
      successTitle: 'Sent!',
      successMessage: 'Thank you for your message. I will reply to the provided email as soon as possible.',
      btnSendNew: 'Send another message',
